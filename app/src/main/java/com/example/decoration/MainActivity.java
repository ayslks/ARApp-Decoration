...
import com.example.decoration.activity.MomentAddActivity;
...
public class MainActivity extends SupportActivity implements BaseMainFragment.OnBackToFirstListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (firstFragment == null) {
            ...
            mFragments[SECOND] = DecorationFragment.newInstance();
            ...
            mFragments[THIRD] = findFragment(CircleFragment.class);
        ...
        navigationBar.defaultSetting()  //恢复默认配置、可用于重绘导航栏
                ...
                .setOnTabClickListener(new EasyNavigationBar.OnTabClickListener() {
                    ...
                    public boolean onTabSelectEvent(View view, int position) {
                        ...
                        navigationBar.getCenterImage().setOnClickListener(new View.OnClickListener() {
                            @Override
